...
interface UgearsHeaderProps {
  showBackButton?: boolean;
  title?: string;
  subtitle?: string;
}

export const UgearsHeader: React.FC<UgearsHeaderProps> = ({
  ...
  return (
    <header className="relative bg-gradient-to-br from-ugears-moonlight-blue via-ugears-moonlight-blue-light to-ugears-moonlight-blue-dark text-white overflow-hidden">
      ...
      <div className="absolute top-4 left-4 opacity-20">
        <UgearsGear size="large" color="brass" speed="slow" />
      </div>
      <div className="absolute top-8 right-8 opacity-20">
        <UgearsGear size="medium" color="steel" speed="reverse" />
      </div>
      <div className="absolute bottom-4 right-4 opacity-20">
        <UgearsGear size="small" color="copper" speed="medium" />
      </div>
