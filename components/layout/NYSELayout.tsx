...
export const NYSELayout: React.FC<NYSELayoutProps> = ({
  children,
  title = 'Beginner Investor Hub',
  description = 'Master investing with precision-engineered tools and professional NYSE standards',
  className = ''
}) => {
      ...
      <div className={`min-h-screen bg-gradient-to-br from-white via-gray-50 to-amber-50 ${className}`}>
        ...
        <footer className="nyse-footer">
          <div className="nyse-container">
            <div className="nyse-footer-content">
              <div className="text-center space-y-6">
                {/* Professional logo */}
                <div className="flex justify-center items-center space-x-4">
                  <NYSEGear size="md" color="brass" speed="slow" />
                  <div className="text-2xl font-bold nyse-heading-primary text-yellow-500">
                    BeginnerInvestorHub
                  </div>
                  <NYSEGear size="md" color="brass" speed="reverse" />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-400">
                    Precision-engineered investment education with NYSE professional standards
                  </p>
                ...
                <nav className="flex flex-wrap justify-center items-center space-x-6 text-sm">
                  <Link
                    href="/privacy"
                    className="text-gray-300 hover:text-yellow-400 transition-colors duration-300 nyse-text-technical"
                  >
                    Privacy Policy
                  </Link>
