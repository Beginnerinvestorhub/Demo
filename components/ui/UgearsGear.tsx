...
export const UgearsGear: React.FC<UgearsGearProps> = ({
  size = 'medium',
  color = 'steel',
  speed = 'medium',
  teeth = 8,
  ...
  const speedMap = {
    slow: 'ugears-rotate-slow',
    medium: 'ugears-rotate-medium',
    fast: 'ugears-rotate-fast',
    reverse: 'ugears-rotate-reverse'
  };
  ...
  return (
    <div
      className={`ugears-gear ${speedMap[speed]} ${className}`}
      style={{
        width: sizeMap[size],
        height: sizeMap[size],
        background: colorMap[color],
