...
export const UgearsInput: React.FC<UgearsInputProps> = ({
  type = 'text',
  placeholder,
  value,
  onChange,
  ...
  const variantClasses = {
    mechanical: 'ugears-input-mechanical',
    ...
    <div className={`${baseClasses} ${className}`} style={style}>
      ...
      <div className="relative">
        ...
        <input
          ...
          style={{
            fontFamily: 'var(--ugears-font-technical)',
            backgroundColor: variant === 'mechanical' ? 'white' : undefined,
            borderColor: error ? '#DC2626' : focused ? 'var(--ugears-brushed-copper)' : undefined
          }}
        />
